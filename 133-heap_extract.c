 ...
 * @tree: It is the ptr to the root node
...
/**
 * _preorder -It  goes thru a binary tree using pre-order traversal
 * @tree: This is the ptr to the root node of the tree to traverse
 * @node: It is the last note in traverse
 * @height: This is the height of the tree
 * Return: It has nothing to return
 */
 ...
 * @root: It is the ptr to the binary heap
 */
 ...
 * @root: This is the ptr to the heap root
 * Return: It returns the num of extracted node
 **/
