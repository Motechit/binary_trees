...
/**
 * height - It easures the height of a binary tree
 * @tree: This is the ptr to the root node
 * Return: If tree is NULL, the fxn returns - 0, othererwise height
 */
 ...
 * @tree: This is the double ptr to the root node
 * @parent: This is the parent node of the current working node
 * @new: This is the double ptr to store the new node
 * @value: This is the value to insert into the AVL tree
 * Return: A ptr to the new root after insertion/ NULL on failure
 */
 ...
 * @tree: This is the double ptr to the root node
 * @value: This is the value to insert into the AVL tree
 * Return: It returns the ptr to the inserted node/NULL on failure
 */
